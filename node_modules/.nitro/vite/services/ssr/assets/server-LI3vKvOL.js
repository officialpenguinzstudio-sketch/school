...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BOTjTJHZ.js");
...
const manifest = {
  "014feeb62350dcb3c1604586a7c738d656d284d9ae4638c2346a9a2808166c31": {
    ...
    importer: () => import("./submissions.functions-Cqdox-vA.js")
  },
  ...
  "1c641ee571e61ae8a41d816b0c5322e45d9aecaab1aeba0eedca263dd0963fba": {
    ...
    importer: () => import("./forms.functions-DsW2Kayl.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BkKrKimK.js").then((n) => n.r),
    import("./start-CBPa8C3o.js"),
