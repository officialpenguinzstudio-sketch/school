...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BOTjTJHZ.mjs");
...
const manifest = {
  "014feeb62350dcb3c1604586a7c738d656d284d9ae4638c2346a9a2808166c31": {
    functionName: "getLeaderboard_createServerFn_handler",
    importer: () => import("./submissions.functions-Cqdox-vA.mjs")
  },
  "0555f3e448c5dec7fda8f685da7f3772d4cf3ad07697971ab4d6865f102d7150": {
    functionName: "submitQuiz_createServerFn_handler",
    importer: () => import("./submissions.functions-Cqdox-vA.mjs")
  },
  "06a64a7a092e60a0091030f99fe6bf18dac2b6b9e7cb3b01ca949347c182918a": {
    functionName: "getDashboardStats_createServerFn_handler",
    importer: () => import("./submissions.functions-Cqdox-vA.mjs")
  },
  "1c641ee571e61ae8a41d816b0c5322e45d9aecaab1aeba0eedca263dd0963fba": {
    functionName: "deleteForm_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "49d69718854de24c8702a89cf3c0a9df4895d8070749c145bce03d713cc502e9": {
    functionName: "getFormForQuiz_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "5d9211d3240dce68af5737fec078ee48fb5558618e9bd41f21d3c6986043680d": {
    functionName: "getCurrentUser_createServerFn_handler",
    importer: () => import("./auth.functions-D4xWokrq.mjs")
  },
  "6b2368e01b9d9c0b0581503c38eb8a4885eb357baa4378729db997d501be91ca": {
    functionName: "createStudent_createServerFn_handler",
    importer: () => import("./users.functions-BRBGxQHZ.mjs")
  },
  "70b837ca04fbbc9c9a7073a089837beb1985f7ebc70ee21dadc9b81aaf7f7eaa": {
    functionName: "getMySubmissions_createServerFn_handler",
    importer: () => import("./submissions.functions-Cqdox-vA.mjs")
  },
  "781bc413e9193340db58fe33e2fc1fc9399b3fdca04efa600bdb8c106512e914": {
  ...
  "96360126a2b7e7131920d620f2e02b8349d25791e143d804f1650d567f9beebf": {
    functionName: "listAdminForms_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "9849aa4e5232a4914539e6de52acec9b752da4370b6a805710dda87e9dd76727": {
    functionName: "getFormReview_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "9bf86eb5a59c955e5d6b181f4e049d966f5cd3c2e02d98ab937b0f9fbc7e4ae4": {
    functionName: "listPublishedForms_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "9d1b5c73dff9930f9ced8d1bf1b60af0c0af6a5031f4b7a992f442e705ccc03a": {
    functionName: "getQuestionCount_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "d74d4b29fbab4cd8ae68e79af262cca14fc64b667ddcf518d8c2f4bd7a163261": {
    functionName: "toggleStudentDisabled_createServerFn_handler",
    importer: () => import("./users.functions-BRBGxQHZ.mjs")
  },
  "eb443cb4d4db008126a834365cd1bf193abe2d722427d86fea21a647c311f95b": {
    functionName: "loginWithPin_createServerFn_handler",
    importer: () => import("./auth.functions-D4xWokrq.mjs")
  },
  "ec7ee786be50570d3408460666c9d14c8e9b6244bead39fdbbd2eff28b2cab22": {
    functionName: "createForm_createServerFn_handler",
    importer: () => import("./forms.functions-DsW2Kayl.mjs")
  },
  "f6a17220f53f43f0be0bb4675b08bc7d0abc86f67b0a49eb578011f1aff6e341": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BkKrKimK.mjs").then((n) => n.r),
    import("./start-CBPa8C3o.mjs"),
